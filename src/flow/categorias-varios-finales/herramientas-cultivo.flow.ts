...
import herramientas from "../../data/varios/herramientas-cultivo.json";
...
const herramientasCultivo: FormattedProduct[] = herramientas.map((dato) => ({
  nombre: dato.Name,
...
.addAnswer(
  "¿Tienes algo en mente de la herramienta/accesorio que estás buscando para tu cultivo? "
)
.addAction(
  { capture: true },
  ...
  .addAnswer(" Encuentra estos y más herramientas para cultivo en: https://ganeshgrowshop.com/es/herramientas-y-accesorios/ ")
  .addAnswer(
