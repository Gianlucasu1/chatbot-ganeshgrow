...
import armarios from "../../data/varios/armarios-cultivo.json";
...
const armariosCultivo: FormattedProduct[] = armarios.map((dato) => ({
  nombre: dato.Name,
 ...
 */
export default BotWhatsapp.addKeyword(["Armarios Cultivo"])
.addAnswer(
  "¿Tienes algo en mente del armario que estás buscando? "
)
.addAction(
  { capture: true },
  ...
  .addAnswer(" Encuentra estos y más armarios de cultivo en: https://ganeshgrowshop.com/es/armarios-de-cultivo/ ")
  .addAnswer(
