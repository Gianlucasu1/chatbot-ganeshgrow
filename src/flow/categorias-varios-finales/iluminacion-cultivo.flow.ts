...
import iluminaciones from "../../data/varios/iluminacion-cultivo.json";
...
const iluminacionesCultivo: FormattedProduct[] = iluminaciones.map((dato) => ({
  nombre: dato.Name,
 ...
 */
export default BotWhatsapp.addKeyword(["Iluminacion Cultivo"])
.addAnswer(
  "¿Tienes algo en mente del producto de iluminación que estás buscando para tu cultivo? "
)
.addAction(
  { capture: true },
  ...
  .addAnswer(" Encuentra estos y más productos de iluminación para tu cultivo en: https://ganeshgrowshop.com/es/iluminacion/ ")
  .addAnswer(
