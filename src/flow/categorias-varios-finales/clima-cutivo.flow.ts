...
import climas from "../../data/varios/clima-cultivo.json";
...
const climasCultivo: FormattedProduct[] = climas.map((dato) => ({
  nombre: dato.Name,
 ...
 */
export default BotWhatsapp.addKeyword(["Clima Cultivo"])
.addAnswer(
  "¿Tienes algo en mente del producto para el clima que estás buscando para tu cultivo? "
)
.addAction(
  { capture: true },
  ...
  .addAnswer(" Encuentra estos y más productos de clima de cultivo en: https://ganeshgrowshop.com/es/clima/ ")
  .addAnswer(
