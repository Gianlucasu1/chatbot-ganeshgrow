...
import vaporizadores from "../../data/varios/vaporizadores.json";
...
const vapos: FormattedProduct[] = vaporizadores.map((dato) => ({
  nombre: dato.Name,
 ...
 */
export default BotWhatsapp.addKeyword(["Vaporizadores"])
.addAnswer(
  "¿Tienes algo en mente del vaporizador que estás buscando? "
)
.addAction(
  { capture: true },
  ...
  .addAnswer(" Encuentra estos y más vaporizadores en: https://ganeshgrowshop.com/es/vaporizadores ")
  .addAnswer(
